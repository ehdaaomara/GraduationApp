...
//  }
  return (
     ...
     <ImageBackground
                            source={require("../../conts/images/photo_2024-01-16_13-58-47.jpg")}
                            style={{ width:width*1, height:height*1,alignSelf:"center"}}
                        >

                          <View>
<Text style={{color:"#fff",fontSize:35,fontWeight:'bold',marginTop:490,marginLeft:30}}>Enjoy browsing</Text>

<Text style={{color:"#fff",fontSize:35,fontWeight:'bold',marginTop:5,marginLeft:30}}>our application ...</Text>
<TouchableOpacity style={{width:100,height:45,backgroundColor:"#eeeeef",borderRadius:25,marginTop:20,marginLeft:235,opacity:0.6}}>
