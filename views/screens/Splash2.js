...
//  }
  return (
     ...
     <ImageBackground
                            source={require("../../conts/images/photo_2024-01-16_00-32-57.jpg")}
                            style={{ width:width*1, height:height*1,alignSelf:"center"}}
                        >

                          <View>
<Text style={{color:"#fff",fontSize:35,fontWeight:'bold',marginTop:490,marginLeft:30}}>Explore the beauty</Text>

<Text style={{color:"#fff",fontSize:35,fontWeight:'bold',marginTop:5,marginLeft:30}}>of the world !</Text>
